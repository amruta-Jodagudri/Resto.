...
const About = () => {
    return (
        <div className="about-container">
            <img src={aboutBG} className="about-bg-img" alt="..." />
            <div className="card-img-overlay text-center about-overlay">
                <h1 className="card-title about-title">About Us</h1>
                ...
                <h2 className="card-title about-subtitle">Bringing the World to Your Table !!</h2>
                <div className="about-cards-container">
                    ...
                    <div className="card about-card">
                        <img src={healthy} className="card-img-top" alt="..." />
                        <div className="card-body">
